...
save('/media/nnelsen/SharedHDD2TB/datasets/eit/dbar/data/theta.mat', 'theta', 'Ntheta', 'Dtheta');
...
for kkk = 1:length(Kvec)
    ...
    save(['/media/nnelsen/SharedHDD2TB/datasets/eit/dbar/hmatrices/ex2Hk_', num2str(kkk), '.mat'], 'Hk');
